...
INSERT INTO TBL_MEMBER(ID, MEMBER_NAME, MEMBER_EMAIL,CREATED_DATE,UPDATED_DATE, MEMBER_STATUS, MEMBER_PROFILE_PATH)
VALUES (SEQ_MEMBER.NEXTVAL, '허세웅','hsw@naver.com', SYSDATE, SYSDATE, '활성','/images/main/baemin.png');
